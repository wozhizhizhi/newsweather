...
import com.aji.newsweather.gson.Forecast;
import com.aji.newsweather.gson.Weather;
import com.aji.newsweather.net.OKHttpUtils;
import com.aji.newsweather.service.AutoUpdateService;
import com.aji.newsweather.util.ImageLoadUtils;
        ...
        OKHttpUtils.sendOkHttpRequest(requestBingPic, new Callback()
        {
            ...
            public void onResponse(Call call, Response response) throws IOException
            {
                ...
                runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ImageLoadUtils.loadImage(WeatherActivity.this , bingPic , bingPicImg);
                    }
                });
            }
