...
//        }
//
//        HintDialog dialog = new HintDialog(context, UiUtils.getStringFromID(R.string.tips), content, btnStr, listener);
//        dialog.show();
//
//        return dialog;
//    }
...
//                                        View.OnClickListener listener)
//    {
//        return showDialog(context, content, UiUtils.getStringFromID(R.string.sure), listener);
//    }
...
//     * @param context
//     */
//    public static HintDialog showDialog(Context context,String title, String content, String sureBtnStr,String cancelBtnStr, View.OnClickListener listener)
//    {
//        HintDialog dialog = new HintDialog(context, title, content, sureBtnStr, cancelBtnStr, listener);
//        showDialog(context, dialog);
//        return dialog;
//    }
    ...
    public static String getStringFromID(int StringID){
